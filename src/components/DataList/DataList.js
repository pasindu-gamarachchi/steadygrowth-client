...
const DataList = ({handleStock, symbDef, isValid}) => {
    ...
    return (
        <div className="dataListContainer">
            ...
            <input className={!isValid?'dataListContainer__inp dataListContainer__inp--err':'dataListContainer__inp'} list="stocks" id="stock-choice" onSelect={handleStock} name="symb" placeholder="" value={symbDef} />
            <datalist id="stocks">
                {
                    Stocks.map(
                        (elem) =>{
